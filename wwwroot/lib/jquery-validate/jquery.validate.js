    ...
    $.extend($.fn,
        {
            ...
            rules: function(command, argument) {
                var element = this[0],
                    isContentEditable = typeof this.attr("contenteditable") !== "undefined" &&
            ...
            prototype: {
                ...
                showErrors: function(errors) {
                    if (errors) {
                        ...
                        this.errorList = $.map(this.errorMap,
                ...
                elementValue: function(element) {
                    var $element = $(element),
                        type = element.type,
                        isContentEditable = typeof $element.attr("contenteditable") !== "undefined" &&
