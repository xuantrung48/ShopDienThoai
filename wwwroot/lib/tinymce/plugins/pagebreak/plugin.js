(function() {
    var pagebreak = (function() {
        ...
        var setup = function(editor) {
            ...
            var pageBreakSeparatorRegExp = new RegExp(separatorHtml.replace(/[\?\.\*\[\]\(\)\{\}\+\^\$\:]/g,
                    function(a) {
                        return "\\" + a;
                    }),
                "gi");
            ...
            editor.on("PreInit",
                function() {
                    editor.serializer.addNodeFilter("img",
                        function(nodes) {
                            ...
                            while (i--) {
                                ...
                                if (className && className.indexOf("mce-pagebreak") !== -1) {
                                    ...
                                    if (editor.schema.getBlockElements()[parentNode.name] &&
