(function() {
    var textcolor = (function() {
        ...
        var register = function(editor) {
            editor.addCommand("mceApplyTextcolor",
                function(format, value) {
                    TextColor.applyFormat(editor, format, value);
                });
            editor.addCommand("mceRemoveTextcolor",
                function(format) {
                ...
                if (global$1.DOM.getParent(e.target, ".mce-custom-color-btn")) {
                    ...
                    colorPickerCallback.call(editor,
                        function(value) {
                            ...
                            customColorCells = global$2.map(tableElm.rows[tableElm.rows.length - 1].childNodes,
                                function(elm) {
                            ...
                            if (i === cols) {
                                for (i = 0; i < cols - 1; i++) {
                                    setDivColor(customColorCells[i],
