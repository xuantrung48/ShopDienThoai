(function() {
    var lists = (function(domGlobals) {
        ...
        var findSubLists = function(parentList) {
            return global$5.grep(parentList.querySelectorAll("ol,ul,dl"),
                function(elm) {
        ...
        var getSelectedSubLists = function(editor) {
            ...
            if (isParentListSelected(parentList, selectedBlocks)) {
                ...
                return global$5.grep(selectedBlocks,
                    function(elm) {
        ...
        var findParentListItemsNodes = function(editor, elms) {
            var listItemsElms = global$5.map(elms,
                function(elm) {
        ...
        var getSelectedListItems = function(editor) {
            var selectedBlocks = editor.selection.getSelectedBlocks();
            return global$5.grep(findParentListItemsNodes(editor, selectedBlocks),
                function(block) {
        ...
        var browsers = [
            ...
            },
            {
                ...
                search: function(uastring) {
                    return (contains(uastring, "safari") || contains(uastring, "mobile/")) &&
                        contains(uastring, "applewebkit");
                }
            }
        ];
        ...
        var composeEntries = function(editor, entries) {
            return bind(groupBy(entries, isIndented),
                function(entries) {
        ...
        var indentSelectedEntries = function(entries, indentation) {
            each(filter(entries, isSelected),
                function(entry) {
        ...
        var getItemSelection = function(editor) {
            ...
            return lift2(find(selectedListItems, not(hasFirstChildList)),
        ...
        var updateListAttrs = function(dom, el, detail) {
            ...
            global$5.each(dom.select("li", el),
                function(li) {
        ...
        var applyList = function(editor, listName, detail) {
            ...
            global$5.each(getSelectedTextBlocks(editor, rng, root),
                function(block) {
        ...
        var toggleMultipleLists = function(editor, parentList, lists, listName, detail) {
            if (parentList.nodeName === listName && !hasListStyleDetail(detail)) {
                ...
                global$5.each([parentList].concat(lists),
                    function(elm) {
        ...
        var normalizeLists = function(dom, element) {
            global$5.each(global$5.grep(dom.select("ol,ul", element)),
                function(ul) {
        ...
        var backspaceDeleteCaret = function(editor, isForward) {
            return backspaceDeleteFromListToListCaret(editor, isForward) ||
