(function() {
    var spellchecker = (function(domGlobals) {
        ...
        var hasProPlugin = function(editor) {
            if (/(^|[ ,])tinymcespellchecker([, ]|$)/.test(editor.settings.plugins) &&
                global.get("tinymcespellchecker")) {
                if (typeof domGlobals.window.console !== "undefined" && domGlobals.window.console.log) {
                    domGlobals.window.console.log("Spell Checker Pro is incompatible with Spell Checker plugin! " +
        ...
        var DomTextMatcher = function(node, editor) {
            ...
            function stepThroughMatches(node, matches, replaceFn) {
                ...
                out:
                    while (true) {
                        if (blockElementsMap[curNode.nodeName] ||
                        ...
                        } else if ((!hiddenTextElementsMap[curNode.nodeName] || blockElementsMap[curNode.nodeName]) &&
                            curNode.firstChild) {
        ...
        var sendRpcCall =
            function(editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
        ...
        var spellcheck = function(editor,
            pluginUrl,
            startedState,
            textMatcherState,
        ...
        var addToDictionary =
            function(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans) {
                editor.setProgressState(true);
                sendRpcCall(editor,
                    pluginUrl,
                    currentLanguageState,
        ...
        var ignoreWord = function(editor, startedState, textMatcherState, word, spans, all) {
            ...
            if (all) {
                global$1.each(editor.dom.select("span.mce-spellchecker-word"),
                    function(span) {
        ...
        var markErrors = function(editor, startedState, textMatcherState, lastSuggestionsState, data) {
            ...
            var bookmark = editor.selection.getBookmark();
            getTextMatcher(editor, textMatcherState).find(Settings.getSpellcheckerWordcharPattern(editor)).filter(
                function(match) {
        ...
        var getItems = function(editor) {
            return global$1.map(Settings.getLanguages(editor).split(","),
                function(langPair) {
        ...
        var register$1 = function(editor,
            ...
            var buttonArgs = {
                ...
                onPostRender: function(e) {
                    var ctrl = e.control;
                    editor.on("SpellcheckStart SpellcheckEnd",
                        function() {
        ...
        var suggestionsMenu;
        var showSuggestions = function(editor,
            pluginUrl,
            lastSuggestionsState,
            startedState,
            textMatcherState,
            ...
            if (hasDictionarySupport) {
                items.push({
                    ...
                    onclick: function() {
                        Actions.addToDictionary(editor,
                            pluginUrl,
                            startedState,
                            textMatcherState,
                            currentLanguageState,
        ...
        global.add("spellchecker",
            function(editor, pluginUrl) {
