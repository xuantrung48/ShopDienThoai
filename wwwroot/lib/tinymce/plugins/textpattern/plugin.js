    ...
    var textpattern = (function(domGlobals) {
        ...
        var get$1 = function(patternsState) {
            ...
            var getPatterns = function() {
                return __spreadArrays(patternsState.get().inlinePatterns,
        ...
        var findEndPattern = function(patterns, text, offset, delta) {
            ...
            for (i = 0; i < patterns.length; i++) {
                ...
                if (pattern.end !== undefined &&
                    isMatchingPattern(pattern, text, offset, delta) &&
                    hasContent(offset, delta, pattern)) {
                    return pattern;
                }
            }
        };
        var findInlinePattern = function(patterns, rng, space) {
            ...
            if (endPattern === undefined ||
                ...
                container.data.length <= endPattern.start.length + endPattern.end.length) {
                return;
            }
            return {
                pattern: endPattern,
        ...
        var splitAndApply = function(editor, container, found, inline) {
            ...
            var validFormats = global$4.grep(formatArray,
                function(formatName) {
