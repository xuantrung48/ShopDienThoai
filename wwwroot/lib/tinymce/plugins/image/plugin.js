(function() {
    var image = (function(domGlobals) {
        ...
        var splitTextBlock = function(editor, figure) {
            var dom = editor.dom;
            var textBlock = dom.getParent(figure.parentNode,
                function(node) {
        ...
        var onSrcChange = function(evt, editor) {
            ...
            if (!meta.width && !meta.height) {
                ...
                Utils.getImageSize(editor.documentBaseURI.toAbsolute(control.value()),
                    function(data) {
                        if (data.width && data.height && Settings.hasDimensions(editor)) {
        ...
        var getGeneralItems = function(editor, imageListCtrl) {
            ...
            if (Settings.getClassList(editor)) {
                generalFormItems.push({
                    ...
                    type: "listbox",
                    label: "Class",
                    values: Utils.buildListItems(Settings.getClassList(editor),
                        function(item) {
                            if (item.value) {
            ...
            function showDialog(imageList) {
                ...
                if (imageList) {
                    imageListCtrl = {
                        ...
                        label: "Image list",
                        name: "image-list",
                        values: Utils.buildListItems(imageList,
                            function(item) {
