(function() {
    var advlist = (function() {
        ...
        var register = function(editor) {
            editor.addCommand("ApplyUnorderedListStyle",
                function(ui, value) {
                    Actions.applyListFormat(editor, "UL", value["list-style-type"]);
                });
            editor.addCommand("ApplyOrderedListStyle",
                function(ui, value) {
        ...
        var getNumberStyles = function(editor) {
            var styles = editor.getParam("advlist_number_styles",
        ...
        var styleValueToText = function(styleValue) {
            return styleValue.replace(/\-/g, " ").replace(/\b\w/g,
                function(chr) {
                    return chr.toUpperCase();
                });
        };
        var toMenuItems = function(styles) {
            return global$1.map(styles,
                function(styleValue) {
