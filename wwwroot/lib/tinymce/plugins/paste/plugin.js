(function() {
    var paste = (function(domGlobals) {
        ...
        var register = function(editor, clipboard, userIsInformedState) {
            ...
            editor.addCommand("mceInsertClipboardContent",
                function(ui, value) {
                    if (value.content) {
        ...
        var isPlainText = function(text) {
            return !
                /<(?:\/?(?!(?:div|p|br|span)>)\w+|(?:(?!(?:span style="white-space:\s?pre;?">)|br\s?\/>))\w+\s[^>]+)>/i
                .test(text);
        };
        ...
        var toBlockElements = function(text, rootTag, rootAttrs) {
            ...
            var paragraphs = global$4.map(blocks,
                function(p) {
                    return p.split(/\n/).join("<br />");
                });
        ...
        function isWordContent(content) {
            return /<font face="Times New Roman"|class="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i
                .test(content) ||
        ...
        var filterWordContent = function(editor, content) {
                    ...
                    [
                        ...
                        function(str, spaces) {
                            return spaces.length > 0
                                ? spaces.replace(/./, " ").slice(Math.floor(spaces.length / 2)).split("").join("\xA0")
                                : "";
                        }
                    ]
                ]);
            ...
            var domParser = global$7({}, schema);
            domParser.addAttributeFilter("style",
                function(nodes) {
            ...
            domParser.addAttributeFilter("class",
                function(nodes) {
        ...
        var getImagesFromDataTransfer = function(dataTransfer) {
            var items = dataTransfer.items
                ? map(from$1(dataTransfer.items),
                    function(item) {
                        return item.getAsFile();
                    })
                : [];
            var files = dataTransfer.files ? from$1(dataTransfer.files) : [];
            var images = filter$1(items.length > 0 ? items : files,
                function(file) {
        ...
        var isBrokenAndroidClipboardEvent = function(e) {
            ...
            return domGlobals.navigator.userAgent.indexOf("Android") !== -1 &&
                clipboardData &&
                clipboardData.items &&
            ...
            editor.on("paste",
                function(e) {
                    ...
                    if (global$2.ie &&
                        ...
                        pasteBin.create();
                        editor.dom.bind(pasteBin.getEl(),
                            "paste",
                            function(e) {
                                e.stopPropagation();
                            });
                    ...
                    if (hasContentType(clipboardContent, "text/html")) {
                        ...
                        global$3.setEditorTimeout(editor,
                            function() {
                                insertClipboardContent(clipboardContent, isKeyBoardPaste, plainTextMode, internal);
                            },
                            0);
        ...
        var registerEventsAndFilters = function(editor, pasteBin, pasteFormat) {
            ...
            var src;
            editor.parser.addNodeFilter("img",
        ...
        var create = function(editor, lastRngCell, pasteBinDefaultContent) {
            ...
            pasteBinElm = editor.dom.add(getPasteBinParent(editor),
                "div",
                {
                    'id': "mcepastebin",
                    'class': "mce-pastebin",
        ...
        var getHtml = function(editor) {
            ...
            pasteBinClones = global$4.grep(getPasteBinParent(editor).childNodes,
                function(elm) {
                    return elm.id === "mcepastebin";
                });
            pasteBinElm = pasteBinClones.shift();
            global$4.each(pasteBinClones,
        ...
        var isTableSelection = function(editor) {
            return !!editor.dom.getParent(editor.selection.getStart(),
        ...
        var setup = function(editor, clipboard, draggingInternallyState) {
            if (Settings.shouldBlockDrop(editor)) {
                editor.on("dragend dragover draggesture dragdrop drop drag",
                    function(e) {
                        e.preventDefault();
                        e.stopPropagation();
                    });
            ...
            editor.on("drop",
                function(e) {
                    ...
                    if ((!clipboard.hasHtmlOrText(dropContent) || isPlainTextFileUrl(dropContent)) &&
                        clipboard.pasteImageData(e, rng)) {
                        return;
                    }
                    if (rng && Settings.shouldFilterDrop(editor)) {
                        var content_1 = dropContent["mce-internal"] ||
        ...
        function removeExplorerBrElementsAfterBlocks(editor, html) {
            ...
            var blockElements = [];
            global$4.each(editor.schema.getBlockElements(),
        ...
        function removeWebKitStyles(editor, content, internal, isWordHtml) {
            ...
            content = content.replace(/(<[^>]+) data-mce-style="([^"]+)"([^>]*>)/gi,
                function(all, before, value, after) {
        ...
        var stateChange = function(editor, clipboard, e) {
            ...
            editor.on("PastePlainTextToggle",
                function(e) {
                    ctrl.active(e.state);
                });
        };
