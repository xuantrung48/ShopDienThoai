    ...
    var legacyoutput = (function() {
        ...
        var overrideFormats = function(editor) {
            var alignElements = "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li,table,img",
                fontSizes = global$1.explode(editor.settings.font_size_style_values),
            ...
            global$1.each("b,i,u,strike".split(","),
                function(name) {
            ...
            global$1.each(alignElements.split(","),
                function(name) {
        ...
        var register = function(editor) {
            editor.addButton("fontsizeselect",
                function() {
                    ...
                    editor.$.each(fontsizeFormats.split(" "),
                        function(i, item) {
