(function() {
    var fullpage = (function() {
        ...
        var htmlToData = function(editor, head) {
            ...
            global$1.each(headerFragment.getAll("meta"),
                function(meta) {
            ...
            data.stylesheets = [];
            global$1.each(headerFragment.getAll("link"),
                function(link) {
        ...
        var dataToHtml = function(editor, data, head) {
            ...
            global$1.each("keywords,description,author,copyright,robots".split(","),
                function(name) {
            ...
            global$1.each(data.stylesheets,
                function(stylesheet) {
            ...
            global$1.each(currentStyleSheetsMap,
                function(stylesheet) {
                    stylesheet.remove();
                });
            elm = headerFragment.getAll("body")[0];
        ...
        var unprotectHtml = function(html) {
            return html.replace(/<!--mce:protected ([\s\S]*?)-->/g,
                function(a, m) {
                    return unescape(m);
                });
        };
        ...
        var handleSetContent = function(editor, headState, footState, evt) {
            ...
            each(headerFragment.getAll("style"),
                function(node) {
                    if (node.firstChild) {
            ...
            var currentStyleSheetsMap = {};
            global$1.each(headElm.getElementsByTagName("link"),
                function(stylesheet) {
        ...
        var handleGetContent = function(editor, head, foot, evt) {
            if (!evt.selection && (!evt.source_view || !Settings.shouldHideInSourceView(editor))) {
                evt.content =
                    Protect.unprotectHtml(global$1.trim(head) +
                        "\n" +
