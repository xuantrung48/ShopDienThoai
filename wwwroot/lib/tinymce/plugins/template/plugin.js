    ...
    var template = (function() {
        ...
        var setup = function(editor) {
            editor.on("PreProcess",
                function(o) {
                    ...
                    global$1.each(dom.select("div", o.node),
                        function(e) {
        ...
        var insertIframeHtml = function(editor, win, html) {
            if (html.indexOf("<html>") === -1) {
                ...
                global$1.each(editor.contentCSS,
                    function(url) {
                        contentCssLinks_1 += '<link type="text/css" rel="stylesheet" href="' +
