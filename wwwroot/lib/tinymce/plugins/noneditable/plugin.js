(function() {
    var noneditable = (function() {
        ...
        var convertRegExpsToNonEditable = function(editor, nonEditableRegExps, e) {
            ...
            while (i--) {
                content = content.replace(nonEditableRegExps[i],
                    replaceMatchWithSpan(editor, content, Settings.getNonEditableClass(editor)));
            }
            e.content = content;
        };
        var setup = function(editor) {
            ...
            editor.on("PreInit",
                function() {
                    ...
                    editor.parser.addAttributeFilter("class",
                        function(nodes) {
                    ...
                    editor.serializer.addAttributeFilter(contentEditableAttrName,
                        function(nodes) {
                            var i = nodes.length, node;
                            while (i--) {
                                node = nodes[i];
