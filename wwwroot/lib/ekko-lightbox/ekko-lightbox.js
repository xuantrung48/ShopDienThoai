    ...
    var Lightbox = (function($) {
        ...
        var Lightbox = (function() {
            ...
            function Lightbox($element, config) {
                ...
                var btn = '<button type="button" class="close" data-dismiss="modal" aria-label="' +
                ...
                var dialog = '<div class="modal-dialog" role="document"><div class="modal-content">' +
                    header +
                    body +
                    footer +
                    "</div></div>";
                $(this._config.doc.body).append('<div id="' +
                    this._modalId +
                ...
                if (this._galleryName) {
                    ...
                    if (this._config.showArrows && this._$galleryItems.length > 1) {
                        this._$lightboxContainer.append('<div class="ekko-lightbox-nav-overlay"><a href="#">' +
                ...
                this._$modal.on("show.bs.modal", this._config.onShow.bind(this)).on("shown.bs.modal",
                    function() {
                        _this._toggleLoading(true);
                        _this._handle();
                        return _this._config.onShown.call(_this);
                    }).on("hide.bs.modal", this._config.onHide.bind(this)).on("hidden.bs.modal",
                    function() {
                ...
                this._$lightboxContainer.on("touchstart",
                    function() {
                ...
                [
                    {
                        ...
                        value: function _isImage(string) {
                            return string &&
                                string.match(/(^data:image\/.*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg)((\?|#).*)?$)/i);
                        }
                    }, {
                        key: "_containerToUse",
                        ...
                        value: function _handle() {
                            ...
                            var currentType = this._detectRemoteType(currentRemote,
                        ...
                        value: function _getYoutubeId(string) {
                            ...
                            var matches =
                                string.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/);
                        ...
                        value: function _showInstagramVideo(id, $containerForElement) {
                            ...
                            $containerForElement.html('<iframe width="' +
                                width +
                                '" height="' +
                                height +
                                '" src="' +
                        ...
                        value: function _loadRemoteContent(url, $containerForElement) {
                            ...
                            if (!disableExternalCheck && !this._isExternal(url)) {
                                $containerForElement.load(url,
                                    $.proxy(function() {
                                        return _this3._$element.trigger("loaded.bs.modal");
                                        l;
                                    }));
                            } else {
                                $containerForElement.html('<iframe src="' +
                                    url +
                                ...
                                (function() {
                                    ...
                                    img.onload = function() {
                                        ...
                                        if (_this4._$modalArrows
                                            ...
                                            _this4._$modalArrows.css("display",
                                                ""); // remove display to default to css property
                        ...
                        value: function _resize(width, height) {
                            ...
                            var widthBorderAndPadding = this._padding.left +
                                this._padding.right +
                                this._border.left +
                                this._border.right;
                            ...
                            var maxWidth = Math.min(width + widthBorderAndPadding,
                            ...
                            var borderPadding = this._padding.top +
                                this._padding.bottom +
                                this._border.bottom +
                                this._border.top;

                            //calculated each time as resizing the window can cause them to change due to Bootstraps fluid margins
                            var margins = parseFloat(this._$modalDialog.css("margin-top")) +
                                parseFloat(this._$modalDialog.css("margin-bottom"));

                            var maxHeight = Math.min(height,
                                $(window).height() - borderPadding - margins - headerHeight - footerHeight,
                                this._config.maxHeight - borderPadding - headerHeight - footerHeight);
